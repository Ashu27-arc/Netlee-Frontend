      ...
      <div className="relative overflow-hidden rounded-lg shadow-xl">
        ...
        {imageError ? (
          ...
          <img
            ...
            loading="lazy"
            className={`w-full aspect-[2/3] object-cover rounded-lg transition-opacity duration-300 ${
        ...
        {/* Hover overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg flex flex-col justify-end p-2 sm:p-3">
          <p className="text-white text-xs sm:text-sm font-bold mb-1 line-clamp-2">
